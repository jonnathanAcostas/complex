...
class CanchaCategoriesCreatePage extends StatefulWidget {
  ...
  @override
  State<CanchaCategoriesCreatePage> createState() =>
      _CanchaCategoriesCreatePageState();
}

class _CanchaCategoriesCreatePageState
    extends State<CanchaCategoriesCreatePage> {
  CanchaCategoriesCreateController _con =
      new CanchaCategoriesCreateController();

import 'package:client/src/models/rol.dart';
import 'package:client/src/pages/roles/roles_controller.dart';
        ...
        children: [
          Container(
            ...
            child: FadeInImage(
              ...
              : AssetImage('assts/img/no-image.png'),
            fit: BoxFit.contain,
            fadeInDuration: Duration(milliseconds: 50),
            placeholder: AssetImage('assts/img/no-image.png'),
            )
          ),
          SizedBox(height: 15),
          Text(
